...
本次 B6-M 提升、Phase M 收尾、B2-S / B3-S / B4-S 提升、以及 2026-08-19 Phase M v1 的日频 ST 切口径、**M0 H20 ES** 模型提升、2026-08-22 的前视窗截断口径修正、**BT v3** 执行层提升、2026-08-22 用户明确批准的 **主格改 top3×h5 并按净年化晋升 v3**、同日用户明确批准的 **早停改回 daily_rank_ic 并晋升 v4**、以及 2026-08-23 用户明确批准的 **BT v4 真阶梯 k3×h5**，均已获用户明确确认。CSI1000 研究实盘配置随 B4-S 同步；CSI300 B1 正式实盘配置仍保留。B5-M、B1-S、B2-S、B3-S、M0 H20、M0 H20 ES、M0 H20 t3h5es、BT v1 / v2 / v3 与更早基线保留为历史对照。

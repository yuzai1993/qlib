...
- [x] **Step 3: Implement the minimal shared branch**
...
- [x] **Step 1: Write failing live strategy and ledger tests**
...
- [x] **Step 3: Implement target values, age filtering, and migration**
...
- [x] **Step 1: Write failing model/config/parity tests**
...
- [x] **Step 3: Implement the generic dataset adapter and config guards**
...
- [x] **Step 4: Copy and verify the model**
...
- [x] **Step 5: Create YAMLs and run a real smoke prediction**
...
- [x] **Step 3: Implement protocol-v2 and database migration**
...
- [x] **Step 4: Update planning and publication flow**
...
- [x] **Step 1: Replace intraday tests with failing after-hours tests**
...
- [x] **Step 3: Implement official-close execution**
...
- [x] **Step 4: Add timer scheduling with a shared advance loop**
...
- [x] **Step 1: Write failing monitor and wrapper tests**
...
- [x] **Step 3: Implement generic jobs and explicit zero-order semantics**
...
- [x] **Step 4: Document rollout and inactive external actions**
...
- [x] **Step 1: Run full relevant suites**
...
- [x] **Step 3: Audit design coverage and external prerequisites**
...
- [x] **Step 4: Perform inline final review**
